...
void generate_map(int _xsize, int _ysize, int _fill, int _r1, int _r2, int _count, int** map) {


    int pars[] = { 0, _xsize, _ysize, _fill, _r1, _r2, _count };
    ...
    {
        params->r1_cutoff = pars[ii];
        params->r2_cutoff = pars[ii + 1];
        params->reps = pars[ii + 2];
        params++;
    }
    ...
    *map = (int*)malloc((size_t)(_xsize * _ysize) * sizeof(int));
